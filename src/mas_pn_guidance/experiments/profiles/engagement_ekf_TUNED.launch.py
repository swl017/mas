"""TUNED (offline-optimal) estimator arms — ticket-007 closed-loop comparison.
SimpleEKF sigma_pix=0.15/sta=2; DirectProjection init=50/sta=3/floor=0.03/gate-off."""
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[{**common,
                ...
                'sigma_pix': 0.15, 'sigma_target_acc': 2.0,
        ...
        Node(
            ...
            parameters=[{**common,
                ...
                'sigma_pix': 5.0, 'sigma_target_acc': 3.0,
