...
flowchart LR
    ...
    POL -- "gimbal_cmd_los_rate, zoom_rate_cmd" --> GSTAB
...
| `gimbal_state_rpy_deg` | geometry_msgs/Vector3 | siyi_gimbal_node / los_rate_controller | mas_multiview, point_to_region_node, mas_policy | BEST_EFFORT |
| `camera/zoom_level` | std_msgs/Float64 | los_rate_controller / siyi_gimbal_node | mas_multiview, mas_policy | BEST_EFFORT |
...
| `zoom_rate_cmd` | std_msgs/Float32 | mas_policy | los_rate_controller / siyi_gimbal_node | default |
