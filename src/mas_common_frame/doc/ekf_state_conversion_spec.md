...
4. **Altitude reference** — the mission frame altitude is relative to the WGS84 ellipsoid (same as MAVRos `home_position.geo.altitude`). If MSL altitude is needed, a geoid separation correction must be added.
